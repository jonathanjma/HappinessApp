  ...
  return (
    <>
      <button type="button"
        ...
        <img src={props.comment ? Journal : JournalQuestion /* TODO probably doesn't actually work */} aria-hidden="true" className="w-5 h-5 mr-2 -ml-1" viewBox="0 0 20 20"/>
        Add journal entry
      </button>
        ...
        <Modal.Body>
          <div className="mb-6">
            <label htmlFor="large-input" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Large
              input</label>
            <textarea  id="large-input" value={props.comment}
